...
//pr($birth_value);
//exit();
$get_birthday_value = $this->Birthday->row(array('conditions'=>array('val_1'=>$birthday))); 
for($i=0;$i<=6;$i++){
    $val_5 = $get_birthday_value->val_5;
    array_push($birth_value,$val_5);
}

$val_6 = $get_birthday_value->val_6;
array_push($birth_value,$val_6);

array_push($birth_value,$grand_total1);

for($i=0;$i<=4;$i++){
    $val_8 = $get_birthday_value->val_8;
    array_push($birth_value,$val_8);
}

array_push($birth_value,$grand_total);

$val_15 = $get_birthday_value->val_15;
array_push($birth_value,$val_15);

$val_27 = $get_birthday_value->val_27;
array_push($birth_value,$val_27);

for($i=0;$i<=2;$i++){
    $val_18 = $get_birthday_value->val_18;
    array_push($birth_value,$val_18);
}
//$val_18 = $get_birthday_value->val_18;
//array_push($birth_value,$val_18);
//
...
for($i=0;$i<=3;$i++){
    $val_13 = $get_birthday_value->val_13;
    array_push($birth_value,$val_13);
}

$val_14 = $get_birthday_value->val_14;
array_push($birth_value,$val_14);

$val_10 = $get_birthday_value->val_10;
array_push($birth_value,$val_10);
...
//            }
//            else{
//                $get_birthday_value = $this->db->query("SELECT val_$i from hr_birthday where val_1='$birthday'")->row();  
//                $var= 'val_'.$i;
//                array_push($birth_value,$get_birthday_value->$var);
//            }
//          
