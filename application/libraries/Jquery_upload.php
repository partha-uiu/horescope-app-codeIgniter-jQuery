...
class Jquery_upload
{
    ...
    //function __construct($options = null, $initialize = true) { //default syntex
    function __construct($options = null, $initialize = true) { //cakephp component syntex
        $this->options = array(
...
//    }
    ...
    public function post($print_response = true) {
        ...
        //custom func call to save data to database
        //$this->saveToDatabase();
    ...
    /*
     * custom function to save data to database
     */
    public function saveToDatabase($files= array()) {
        if(empty($files))
            return false;
        $this->MediaModel = ClassRegistry::init('Media');
