                    ...
                    <div class="box login">
                        ...
                        <div class="box-content">
                            <?php if ($this->ahrsession->get('warning')) { ?>
                                <div class="alert" style="margin-bottom:27px;margin-top:-12px;z-index: 123;">
                            ...
                            <form class="form-horizontal" method="post" action="" style="margin-top: 0px;">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        Don't have an account? Please <a href="<?php echo site_url(CPREFIX . '/home/register'); ?>">click here</a> to create an account.
                                    </div>
                                </div>
