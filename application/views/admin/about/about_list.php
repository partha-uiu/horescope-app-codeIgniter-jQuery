    ...
    $(document).ready(function() {
        ...
        $('body').on('click','#dataTable .single-delete',function(e) {
            ...
            $.ajax({
                ...
                //xhrFields: {withCredentials: true},
                type: "POST",
                url: '<?php echo site_url(CPREFIX . "/about/delete_about") ?>',
                dataType: 'json',
                context: $(this).parents('table'),
                data: jQuery.param({id: ids})
            }).done(function(rt) {
    ...
    <div class="span12">
        <div class="box">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Quotes List</h5>
            </header>
...
<!--                        <th>Gender</th>-->
                    ...
                    foreach ($items as $item) { ?>
                        <tr>
                            ...
                            <td style="width: 90px;"><?php echo $item->title; ?></td>
                            <td><?php echo $item->description;?></td>

                            <td class="action">
                                <a href="  <?php echo site_url(CPREFIX . "/about/add_about/" . $item->id)?>"><i class="icon-pencil"></i> Edit</a>&nbsp;&nbsp;
