    ...
    <div class="span12">
        <div class="box">
            <header>
                ...
                <h5 style="font-size: 18px; font-weight: bold;">Administrators</h5>
            </header>
...
<!--                                <td><?php $camp = $this->Campaign->row(array('conditions' => array('user_id' => $item->id))); 
                                    if(!empty($camp->title)){echo '<a href="'.  site_url('admin/campaign/add/'.$camp->id).'">'.$camp->title.'</a>';}else{echo 'No Campaign!';} ?></td>-->
...
<!--                                <td><?php echo ''; ?></td>-->
                                ...
                                <td class="action">
                                    <a href="<?php echo site_url(CPREFIX . "/users/administrators/" . $item->id) ?>"><i class="icon-pencil"></i>&nbsp;Edit</a>
...
//                    }, 800);
        ...
        $('body').on('click', '#dataTable .bulk-delete', function(e) {
                ...
                $.ajax({
                    ...
                    //xhrFields: {withCredentials: true},
                    type: "POST",
                    url: '<?php echo site_url(CPREFIX . "/user/delete") ?>',
                    dataType: 'json',
                    context: $(this).parents('table'),
                    data: jQuery.param({id: ids})
...
<div class="row-fluid <?php if(!empty($items) && empty($index)){ echo 'hidden'; } ?>">
    <div class="span12">
        <div class="box for-form-horizontal">
            <header>
                <div class="icons" style="font-size: 20px; color: #0066cc;"><i class="icon-plus-sign"></i></div>
                <h5 style="font-size: 18px; font-weight: bold;">Edit Admin</h5>
                <div class="toolbar">
                    <ul class="nav">
                        <li>
                            <div class="btn-group">
...
//                    ));
                    ?>
                    <?php echo $this->ahrform->input(array('name' => 'fname', 'type' => 'text', 'label' => 'Name')); ?>
...
<!--                    <div class="control-group">
                    ...
                    <div class="form-actions">
                        ...
                        or <a href="<?php echo site_url('/' . CPREFIX . '/users/administrators'); ?>"><i class="icon-backward"></i> Back to list</a>
                    </div>
                </form>
            </div>
        </div>
