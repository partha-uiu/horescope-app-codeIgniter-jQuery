    ...
    $(document).ready(function() {
        ...
        $('body').on('click','#dataTable .single-delete',function(e) {
            ...
            $.ajax({
                ...
                //xhrFields: {withCredentials: true},
                type: "POST",
                url: '<?php echo site_url(CPREFIX . "/testimonials/delete_testimonial") ?>',
                dataType: 'json',
                context: $(this).parents('table'),
                data: jQuery.param({id: ids})
            }).done(function(rt) {
    ...
    <div class="span12">
        <div class="box">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Testimonial List</h5>
            </header>
            <div id="collapse4" class="body">
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    <thead>
                    <tr>
                        <th style="width: 70px;display: none;" class="center">
...
<!--                        <th>Gender</th>-->
                        <th style="width: 70px;" class="center">SL No.</th>
                        <th>Testimonial</th>
                        <th>Given By</th>
                    ...
                    foreach ($items as $item) { ?>
                        <tr>
                            <td class="center" style="display: none;"><input class="check list-control-check" type="checkbox" value="<?php echo $item->id ?>" /></td>
                            <td class="center"><?php echo $x++; ?></td>
                            <td><?php echo $item->testimonial;?></td>
                            <td><?php echo $item->written_by;?></td>

                            <td class="action">
                                <a href="  <?php echo site_url(CPREFIX . "/testimonials/add_testimonial/" . $item->id)?>"><i class="icon-pencil"></i> Edit</a>&nbsp;&nbsp;
