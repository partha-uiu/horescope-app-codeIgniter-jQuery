    ...
    <div class="span12">
        <div class="box for-form-horizontal">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Add Testimonial</h5>
                <div class="toolbar">
                    <ul class="nav">
                        <li>
                            <div class="btn-group">
            ...
            <div id="collapse3" class="accordion-body collapse in body">
                ...
                <form action="" method="post" class="form-horizontal" id="inline-validate" enctype="multipart/form-data">
                    ...
                    <?php echo $this->ahrform->input(array('name' => 'written_by', 'type' => 'text', 'label' => 'Given By')); ?>
                    ...
                    <div class="form-actions">
                        ...
                        or <a href="<?php echo site_url('/' . CPREFIX . '/testimonials/testimonial_list') ?>"><i class="icon-backward"></i> Back to list</a>
                    </div>
                </form>
            </div>
        </div>
