    ...
    <div class="span12">
        <div class="box">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Users Report List</h5>
            </header>
                        ...
                        <?php foreach ($items as $item) { ?>
                            <tr>
                                ...
                                <td><?php if ($item->gender==0)
                                    ...
                                    echo "Female";
                                    ?></td>
                                <td><a href="<?php echo site_url('admin/users_report/download').'/'.$item->id;?>">Report_TechofBliss_<?php echo $item->id; ?>.pdf</a></td>                              
                                 
                               
                             
<!--                                <td class="action">
                                <a href="  <?php // echo site_url(CPREFIX . "/products/products_add/" . $item->id)?>"><i class="icon-pencil"></i> Edit</a>&nbsp;&nbsp;
