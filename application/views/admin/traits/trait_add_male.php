    ...
    <div class="span12">
        <div class="box for-form-horizontal">
            <header>
                ...
                <h5 style="display: inline-block; font-size: 18px; font-weight: bold;">Update Male Trait</h5>
                <div class="toolbar">
                    <ul class="nav">
                        <li>
                            <div class="btn-group">
            ...
            <div id="collapse3" class="accordion-body collapse in body">
                ...
                <form action="" method="post" class="form-horizontal" id="inline-validate" enctype="multipart/form-data">
                    ...
                    <?php echo $this->ahrform->input(array('name' => 'birth_return_val', 'type' => 'textarea','value'=>$this->ahrform->get('birth_return_val'), 'label' => 'Birthday return value')); ?>

<!--                    --><?php //echo $this->input->post('birth_return_val');?>
<!--                    $this->input->post('vendor_id');-->
                    <?php echo $this->ahrform->get('birth_return_val'); ?>
                    <?php echo $this->ahrform->input(array('name' => 'return_details', 'type' => 'textarea', 'label' => 'Details')); ?>
                        </div>
                    </div>
